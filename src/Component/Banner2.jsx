...
import img from "../../public/Animation - 1711777655630.json"
...
const Banner2 = () => {
    return (
        <div className="max-w-7xl mx-auto mt-8">
            ...
            <div className=" h-[65px] bg-[#eb9409]  px-5 md:px-9 md:mx-3">
                <Marquee speed={50} className=" pt-5">
                    <h1 className="text-base lg:text-2xl font-bold text-white tracking-[2px]">
            ...
            <div>
                <div className=" h-[85px] bg-[#eb9409] flex justify-between items-center px-5 md:px-9 md:mx-3">
                    <div className="px-4 py-2 ">
                        <h1 className="text-white text-sm  md:text-2xl  font-serif tracking-wide">Explore the best spices products <br /> Available here !!!
                        </h1>
                    </div>
                    <div className="flex items-center md:gap-2 ">
                        {/* <FaPhoneVolume size={35} color="white"></FaPhoneVolume> */}
                ...
                <div className="grid  grid-cols-2 gap-2 px-2  md:grid-cols-2 lg:grid-cols-3 md:px-3 md:gap-4 mt-4 md:mt-10">

                    <div className="h-[98%] md:h-[200px] relative overflow-hidden cursor-pointer group">
                        <img loading="lazy" className="h-full w-full" src="https://i.ibb.co/sRGwJ34/Cumin-Seeds-2.jpg" alt="" />
                    ...
                    <div className="h-[98%] md:h-[200px] relative overflow-hidden cursor-pointer group">
                        ...
                        <img loading="lazy" className="h-full w-full" src="https://i.ibb.co/YBY2yRH/Dry-Red-Chili-3.jpg" alt="" />
                    ...
                    <div className="h-[98%] md:h-[200px] relative overflow-hidden cursor-pointer group">
                        ...
                        <img loading="lazy" className="h-full w-full" src="https://i.ibb.co/XW0WsFy/Green-Cardamom-8.jpg" alt="" />
                    ...
                    <div className="h-[98%] md:h-[200px] relative overflow-hidden cursor-pointer group">
                        ...
                        <img loading="lazy" className="h-full w-full" src="https://i.ibb.co/QnCDGsn/Dry-Turmeric-3.jpg" alt="" />
                    ...
                    <div className="h-[98%] md:h-[200px] relative overflow-hidden cursor-pointer group">
                        ...
                        <img loading="lazy" className="h-full w-full" src="https://i.ibb.co/cFHnNrF/Cloves-3.jpg" alt="" />
                    ...
                    <div className="h-[98%] md:h-[200px] relative overflow-hidden cursor-pointer group">
                        ...
                        <img loading="lazy" className="h-full w-full" src="https://i.ibb.co/3mVLn3v/Black-Cardamom-3.jpg" alt="" />
