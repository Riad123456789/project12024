                            ...
                            {Data?.map((item) =>
                                ...
                                <SwiperSlide key={item.id}>
                                    <div className={`cursor-pointer bg-gradient-to-r  from-[#0ba360] to-[#3cba92]    px-1 py-1  lg:px-2 lg:py-2 rounded-md `}>
                                        ...
                                        <h1 className='text-[70%] md:text-sm lg:text-xl md:font-semibold font-bold pt-2 text-center'>{item?.name}
                                        </h1>
                                        ...
                                        <ul className='text-[70%] md:text-sm lg:text-base font-semibold px-1 lg:px-3 py-2'>
                                            ...
                                            <li>
                                                Order :
                                                <span className='text-[65%] lg:text-[100%] font-bold lg:font-semibold  ml-1 lg:ml-5'>{item?.order}
                                                </span>
                                            </li>

                                            <li>
                                                Family :
                                                <span className='text-[65%] lg:text-[100%]  font-bold lg:font-semibold  ml-1 lg:ml-4'>{item?.family}
                                                </span>
                                            </li>
